...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button guestLogin = (Button) findViewById(R.id.offline_starten_button);
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            if(sd.getString("Email", "").equals(mEmail)){
               //account existiert
                if(sd.getString("Passwort", "").equals(mPassword)){
                    SharedPreferences.Editor editor = sd.edit();
                ...
                editor.putString("Passwort", mPassword);
                editor.putBoolean("LoggedIn", true);
                editor.putString("Gast", "NoGast");
                editor.apply();
            }
